...
export default function ArchMap() {
  const src = `${import.meta.env.BASE_URL}cell-os-architecture-map.html`;
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "Courier New, monospace" }}>
          ...
          <span style={{ color: "rgba(34,211,238,0.7)", fontSize: "10px", letterSpacing: "0.15em", textTransform: "uppercase" }}>
            架 Full Architecture Map
          </span>
          <span style={{ color: "rgba(255,255,255,0.08)", fontSize: "11px" }}>·</span>
          <span style={{ color: "rgba(255,255,255,0.18)", fontSize: "10px" }}>
            15 Organelles · 17 Substrates · 18 Biophoton Links · 8 Zones
          </span>
        </div>
        <a
          href={src}
      ...
      <iframe
        src={src}
        title="Cell OS Full Architecture Map"
